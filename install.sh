...
sed -i "0,/alex/s//$(whoami)/" ~/.dotfiles/flake.nix
sed -i "0,/Alex/s//$(getent passwd $(whoami) | cut -d ':' -f 5 | cut -d ',' -f 1)/" ~/.dotfiles/flake.nix
sed -i "s/alex.tyrode@outlook.fr//" ~/.dotfiles/flake.nix
